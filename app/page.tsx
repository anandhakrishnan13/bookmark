    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <Card className="max-w-md w-full">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            <i className="block text-right text-xs text-muted-foreground">
              ~ You drop the link, I’ll do the thinking
            </i>
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-border rounded-lg bg-white hover:bg-gray-50 transition-colors text-sm font-medium text-gray-700 shadow-sm cursor-pointer"
          >
            <svg
              width="18"
              height="18"
